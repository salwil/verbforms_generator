...
def execution_addNotes(csvfile, action="addNotes", version= 6, deckName="verbgen", modelName="Basic"):
    """wrapping function to generate new anki cards directly form a CSVfile"""

    new_ankicards_jsonformat = param_creator(action=action, version= version, deckName= deckName, modelName= modelName, csvfile= csvfile)
...
if __name__ == "__main__":
    ...
    #invoke('createDeck', deck='verbgen')
    #invokejson(notestest)
    #invokejson(guitest)
    #invoke('addNote', Front= 'kid', Back= 'unicorn')

    #result = invoke('deckNames')
    #print('got list of decks: {}'.format(result))

    #new_notes = param_creator()
    #invokejson(new_notes)

    execution_addNotes("test.txt")